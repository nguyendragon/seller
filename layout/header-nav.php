        ...
        <li class="onhover-dropdown">
          ...
          <div class="onhover-show-div notification-dropdown">
            ...
            <ul class="custom-scrollbar">
              <li>
                <div class="media">
                  <div class="notification-img bg-light-primary"><img src="<?=BASE_URL?>/assets/images/avtar/man.png" alt=""></div>
              ...
              <li>
                <div class="media">
                  <div class="notification-img bg-light-secondary"><img src="<?=BASE_URL?>/assets/images/avtar/teacher.png" alt=""></div>
                  <div class="media-body">
              ...
              <li>
                <div class="media">
                  <div class="notification-img bg-light-info"><img src="<?=BASE_URL?>/assets/images/avtar/teenager.png" alt=""></div>
                  <div class="media-body">
              ...
              <li>
                <div class="media">
                  <div class="notification-img bg-light-success"><img src="<?=BASE_URL?>/assets/images/avtar/chinese.png" alt=""></div>
                  <div class="media-body">
